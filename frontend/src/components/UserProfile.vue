<template>
  <div class="min-h-screen bg-gray-50 py-8">
        ...
        <div class="p-6">
          ...
          <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8">
            ...
            <div class="text-center sm:text-left">
              <h2 class="text-2xl font-bold text-gray-900">{{ user.name || 'User Name' }}</h2>
    ...
    <div v-if="message" :class="messageClasses" class="fixed top-4 right-4 p-4 rounded-md shadow-lg z-50">
      <div class="flex items-center">
