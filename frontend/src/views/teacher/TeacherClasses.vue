        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div class="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/30 hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Avg Attendance</p>
                <p class="text-2xl font-bold text-gray-900 mt-1">
                  <Loader v-if="loadingStats" class="w-6 h-6 animate-spin text-orange-600" />
          ...
          <div class="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/30 hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Avg Performance</p>
                <p class="text-2xl font-bold text-gray-900 mt-1">
                  <Loader v-if="loadingClasses" class="w-6 h-6 animate-spin text-purple-600" />
                  <span v-else class="text-lg">{{ averagePerformance }}</span>
                </p>
