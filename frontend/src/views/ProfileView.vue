  ...
  >
        ...
        >
          ...
          >
            ...
            <div class="relative group">
              <div
                class="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden bg-white shadow-2xl border-4 border-white/20 backdrop-blur-sm"
              >
                <img
                  v-if="profileImage"
                  :src="profileImage"
          ...
          >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div class="space-y-4 sm:space-y-6">
                <div
                  class="flex items-center space-x-2 sm:space-x-3 pb-3 sm:pb-4 border-b border-gray-200"
                >
    ...
    >
      <div
        ...
        class="fixed top-4 right-4 left-4 sm:left-auto sm:right-4 p-4 rounded-xl shadow-2xl z-50 max-w-sm mx-auto sm:mx-0"
      >
